...
\centering
\vspace*{0.8cm}
{\sffamily\Huge\bfseries Cost-of-Living Data Platform\par}
\vspace{0.35cm}
{\sffamily\Large Cloud Data Pipeline, Search Taxonomy, and Analytics API\par}
\vspace{0.75cm}
{\large Public Engineering Report \textbar{} 2026\par}
\vspace{1.0cm}

\begin{tabularx}{0.88\linewidth}{p{0.24\linewidth}Y}
\toprule
Repository & \href{https://github.com/BlackMirean/cost-living-data-platform}{BlackMirean/cost-living-data-platform} \\
API prefix & \idx{/api/cost-living} \\
Core stack & FastAPI, Kubernetes, Fission, Redis, KEDA, Elasticsearch \\
Validation & pytest suite and public release check passing \\
\bottomrule
\end{tabularx}

\vspace{1.05cm}
{\sffamily\bfseries\Large Contributors\par}
\vspace{0.35cm}
\begin{tabularx}{0.88\linewidth}{p{0.25\linewidth}Y}
\toprule
Tzz & \href{https://github.com/BlackMirean}{github.com/BlackMirean} \\
R1ta-Xjsmhtio & \href{https://github.com/R1ta-Xjsmhtio}{github.com/R1ta-Xjsmhtio} \\
meicongc & \href{https://github.com/meicongc}{github.com/meicongc} \\
zhantaos & \href{https://gitlab.unimelb.edu.au/zhantaos}{gitlab.unimelb.edu.au/zhantaos} \\
Li & \href{https://gitlab.unimelb.edu.au/yli13923}{gitlab.unimelb.edu.au/yli13923} \\
\bottomrule
\end{tabularx}

\vfill
{\small Public release version. Runtime secrets, generated caches, and local deployment files are excluded.\par}
\end{titlepage}
